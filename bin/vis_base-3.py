...
#     padding: 0px 5px 0px 5px;
    ...
    def cell_counts_cb(self):
        ...
        if self.discrete_scalar == 'cell_type':
            ...
            self.population_plot.ax0.set_title("cell_type", fontsize=10)
        ...
        else:  # something other than cell_type
            ...
            population_plot = PopulationPlotWindow()
            population_plot.ax0.cla()
            ...
            for itype in range(self.discrete_scalar_len[self.discrete_scalar]):
                ...
                mylabel = "label" + str(itype)
                # population_plot.ax0.plot(tval, yval, label=label, linewidth=lw, color=ctcolor)
                population_plot.ax0.plot(tval, yval, linewidth=lw, color=ctcolor)


            population_plot.ax0.set_xlabel('time (mins)')
            population_plot.ax0.set_ylabel('# of cells')
            population_plot.ax0.set_title(self.discrete_scalar, fontsize=10)
            population_plot.ax0.legend(loc='center right', prop={'size': 8})
            population_plot.canvas.update()
            population_plot.canvas.draw()
