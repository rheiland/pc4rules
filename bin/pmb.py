...
#     from simulariumio import UnitData, MetaData, DisplayData, DISPLAY_TYPE, ModelMetaData,foobar
#     simularium_flag = True
# except:
#     print("Unable to import foobar from simulariumio")
#     simularium_flag = False
